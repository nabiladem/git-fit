...
export default function ComparisonSlider({ before, after, labelBefore = "Before", labelAfter = "After" }) {
        ...
        >
            ...
            >
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full flex items-center justify-center group hover:scale-110 transition-transform duration-300">
                    ...
                    <svg className="relative w-6 h-6 text-white/80 drop-shadow-sm" fill="none" viewBox="0 0 24 24" stroke="currentColor">
